...
public class CommunityChestDeck {
    ...
    private static final Card[] cards = {
            new Card(CardType.COMMUNITY_CHEST, "card1"),
            new Card(CardType.COMMUNITY_CHEST, "card2"),
            new Card(CardType.COMMUNITY_CHEST, "card3"),
            new Card(CardType.COMMUNITY_CHEST, "card4"),
    };

    private CommunityChestDeck() {}
